...
$sql=mysql_query("UPDATE course_result SET Assignment='$a1',Final='$f',Total='$total',Grade='$grade',status='post' where no='$roomid'");	

			if(!$sql)
			{
			die("<script>alert('Error! not Updated!');
			window.location=\'viewcourseresult.php\';</script>" . mysql_error());
			}
			else
			{
