...
function fetchDistinctAssignInstructorValues(mysqli $conn, string $column, string $userId): array
{
    $allowedColumns = [
        "department",
        "Student_class_year",
...
if (isset($_SESSION["sun"]) && isset($_SESSION["spw"]) && isset($_SESSION["sfn"]) && isset($_SESSION["sln"]) && isset($_SESSION["srole"])) {
    ...
    $departments = fetchDistinctAssignInstructorValues($conn, "department", $userId);
    $classYears = fetchDistinctAssignInstructorValues($conn, "Student_class_year", $userId);
    $semisters = fetchDistinctAssignInstructorValues($conn, "semister", $userId);
    $sections = fetchDistinctAssignInstructorValues($conn, "section", $userId);
    $courseCodes = fetchDistinctAssignInstructorValues($conn, "corse_code", $userId);
?>
<div id="container">
    <div id="header">
    ...
    <div class="main-row">
        ...
        <div id="content">
            <div id="contentindex5">
                <fieldset style="margin-left: 0;">
                    <legend>Please Select The Following Field</legend>
        ...
        <div id="sidebar">
            <div id="siderightindexphoto">
                ...
                <p>
                    <b><font color="blue">Welcome:</font> <font color="#e70f0a">(<?php echo $firstName . "&nbsp;&nbsp;&nbsp;" . $lastName; ?>)</font></b>
                </p>
                <?php if ($photoPath !== "") { ?>
