...
departmentRenderPageStart(
    ...
    "Review the submitted records for instructors who prepared exams."
);
?>
...
<?php if (!$rows) { ?>
<div class="department-empty">No exam-preparation workload records were found for your account.</div>
<?php } else { ?>
<fieldset>
    <legend><b>List of instructors who have participated in preparing exams</b></legend>
    <div class="department-table-wrap">
        <table border="1" id="resultTable" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <td><?php echo departmentH($row['No_of_Exams_prepared']); ?></td>
            </tr>
            <?php } ?>
        </table>
    </div>
