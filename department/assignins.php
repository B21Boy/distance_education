...
$sq = mysql_query("SELECT * FROM assign_instructor where uid='$id' and department='$dpt' and corse_code='$ccode' and cname='$cname' and chour='$ch' and Iname='$name' and section='$sec' and Student_class_year='$scy' and semister='$sem'");
	$c=mysql_num_rows($sq);
	if($c<='0')
	{
