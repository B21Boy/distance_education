...
<form action="insertmassignment.php"method="POST" >
...
<tr><td>Course he/she tutored:</td><td><input type="text" name="cs" id="cs" class="ed" style="height: 30px;width: 200px;" required="required"  placeholder="Please enter course" />
<script type="text/javascript">
...
<tr><td>No.of Exams Marked:</td><td><input type="text" class="ed" name="nem" id="nem" style="height: 30px;width: 200px;" required="required"  placeholder="Please enter No.of Exams Marked" />
<script type="text/javascript">
...
<tr><td>No.of Assignments Marked:</td><td><input type="text" class="ed" name="nam" id="nam" style="height: 30px;width: 200px;" required="required"  placeholder="Please enter No.of Assignments Marked" />
<script type="text/javascript">
				    var f1 = new LiveValidation('nam');
				    f1.add(Validate.Presence,{failureMessage: " Please enter No.of Assignments Marked "});
				     f1.add(Validate.Format,{pattern: /^[0-9]+$/ ,failureMessage: " It allows only Number"});
				 </script> 	
</td></tr>
