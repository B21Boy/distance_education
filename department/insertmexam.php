...
$sql="INSERT INTO payment_table(UID,c_code,Instructors_Name,Rank,Course_Code,CrHr,Department,Year,No_of_Exams_Marked,unread,type) VALUES('$id','$id1','$name','$rk','$cs','$cr','$dept','$year','$no','$st','mexam')";
