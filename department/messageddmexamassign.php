...
?>
	...
	if(!$status) die("Failed to select database!");
		$uid=$_SESSION['suid'];
?>
<fieldset><legend><b>List of Instructors who have participated in marking exam & asignment</b></legend>
<form action="" method="post">
<p align="center" style="color: #2773d8;font-family: time new romans;font-size: 17;">Number of record:<?php 
$count_item=mysql_query("select * from payment_table where UID='$uid' and type='mexamassign'" ) or die(mysql_error());
$count=mysql_num_rows($count_item);	
echo"<font color='red'>".($count)."</font>"; ?></p>							
									<?php
$query1 = mysql_query("select * from payment_table where UID='$uid' and type='mexamassign'")
or die(mysql_error());
?>
...
$sql = "SELECT * FROM payment_table where UID='$uid' and type='mexamassign'";
...
<table border="1" id="resultTable" cellspacing="0" width="80%" >
<tr bgcolor="#CAE8EA">
<th>No</th>
<th>Sender<br>UID</th>
