...
departmentRenderPageStart(
    ...
    "Department Head",
    "Combined exam and assignment workload",
    "Review records where instructors reported both exam-marking and assignment-marking work."
);
?>
...
<?php if (!$rows) { ?>
<div class="department-empty">No combined workload records were found for your account.</div>
<?php } else { ?>
<fieldset>
    <legend><b>List of instructors who have participated in marking exams and assignments</b></legend>
    <div class="department-table-wrap">
        <table border="1" id="resultTable" cellspacing="0" width="100%">
            <tr bgcolor="#CAE8EA">
                <th>No</th>
                <th>Sender UID</th>
                <th>Name of marking</th>
            ...
            <tr>
                ...
                <td><?php echo departmentH($row['No_of_Exams_Marked']); ?></td>
                <td><?php echo departmentH($row['No_of_Assignment_Marked']); ?></td>
            </tr>
            <?php } ?>
        </table>
    </div>
