...
$sql="INSERT INTO payment_table(UID,c_code,Instructors_Name,Rank,Course_Code,CrHr,No_of_Exams_prepared,unread,type) VALUES('$id','$id1','$name','$rk','$cpe','$cr','$noep','$st','pexam')";
