...
departmentRenderPageStart(
    ...
    "Department Head",
    "Exam marking workload",
    "Review instructors who submitted exam-marking workload records for this department account."
);
?>
...
<?php if (!$rows) { ?>
<div class="department-empty">No exam-marking workload records were found for your account.</div>
<?php } else { ?>
<fieldset>
    <legend><b>List of instructors who have participated in marking exams</b></legend>
