...
departmentRenderPageStart(
    ...
    "Department Head",
    "Assignment marking workload",
    "Review assignment-marking workload records that were submitted to this department account."
);
?>
...
<?php if (!$rows) { ?>
<div class="department-empty">No assignment-marking workload records were found for your account.</div>
<?php } else { ?>
<fieldset>
    <legend><b>List of instructors who have participated in marking assignments</b></legend>
