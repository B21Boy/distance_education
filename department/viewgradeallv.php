...
$sec=$_SESSION['ss'];
$year=$_SESSION['yy'];
$co=mysql_query("SELECT * FROM grade where department='$dept' and year='$year' and section='$sec' and status='approve' and checking='pending'" ) or die(mysql_error());
$c=mysql_num_rows($co);
if($c>='1'){
...
<table><tr><td bgcolor="003366" width="100px" align="center"><a href="allrequestgr.php"  style="color: #ffffff;font-size: 30px;text-decoration: none;">Back</a></td>
		


<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>
<p align="center" style="color: #2773d8;font-family: time new romans;font-size: 17;">Number of record:<?php 
$count_item=mysql_query("SELECT * FROM grade where department='$dept' and year='$year' and section='$sec'  and status='approve' and checking='pending'" ) or die(mysql_error());
$count=mysql_num_rows($count_item);	
echo"<font color='red'>".($count)."</font>"; ?></p>	
</td><td>&nbsp;&nbsp;&nbsp;</td><td  bgcolor="#003366" width="120px" align="center"><a href="approvedgrade.php"  style="color: #ffffff;font-size: 20px;text-decoration: none;">Approve All</a></td></tr></table>	<br/>					
<?php	
							
$sql = "SELECT * FROM grade where department='$dept' and year='$year' and section='$sec'  and status='approve' and checking='pending'";
