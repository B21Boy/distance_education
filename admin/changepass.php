                ...
                <div class="change-pass-shell">
                    <div class="admin-page-header">
                        <div>
                            ...
                            <p class="admin-page-copy">Update your admin password using the current login format used by the system. Your new password must match the confirmation field.</p>
                        </div>
                    </div>
                    <div class="change-pass-panel">
                        ...
                        <form action="uaccounta.php" method="POST" class="change-pass-form" onsubmit="return validatePasswordForm();">
                            ...
                            <p class="change-pass-hint">Use a password you can remember. The new password cannot be the same as the old password.</p>
