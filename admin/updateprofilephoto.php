    ...
    <div class="main-row">
        ...
        <div id="sidebar">
            <div id="siderightindexphoto">
                ...
                <p>
                    <b><font color="blue">Welcome:</font><font color="#b00404">(<?php echo $first_name . "&nbsp;&nbsp;&nbsp;" . $last_name; ?>)</font></b>
                </p>
                <?php if ($photo_path !== '') { ?>
                <p><b><img src="<?php echo $photo_path; ?>" width="180" height="160" alt="Administrator profile photo"></b></p>
                <?php } ?>
