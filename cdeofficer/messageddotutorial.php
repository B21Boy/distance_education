...
$count_item=mysql_query("select * from payment_table where unread='yes' and status='yes' and type='tutorial'" ) or die(mysql_error());
$count=mysql_num_rows($count_item);	
echo"<font color='red'>".($count)."</font>"; ?></p>							
									<?php
$query1 = mysql_query("select * from payment_table where unread='yes' and status='yes' and type='tutorial'")
or die(mysql_error());
?>

<?php	
							
$sql = "SELECT * FROM payment_table where unread='yes' and status='yes' and type='tutorial'";
