...
if (isset($_SESSION['sun']) && isset($_SESSION['spw']) && isset($_SESSION['sfn']) && isset($_SESSION['sln']) && isset($_SESSION['srole'])) {
    ...
    $unseenPage = 'unreaddotutorial.php';
                ...
                <div class="admin-page-shell">
                    <div class="admin-page-header">
                        <div>
                            ...
                            <h1 class="admin-page-title">Seen Tutorial Requests</h1>
                            <p class="admin-page-copy">Browse tutorial payment requests that have already been reviewed and marked as seen.</p>
                        </div>
                    </div>
                    <div class="admin-page-panel">
                        <div class="admin-page-toolbar">
                            ...
                            <span class="page-stat-chip"><?php echo $seenCount; ?> seen tutorial records</span>
                        </div>
                        <?php if ($seenCount != '0') { ?>
                        ...
                        <?php } else { ?>
                        <div class="admin-page-empty">No seen tutorial requests are available yet.</div>
                        <?php } ?>
                    </div>
                </div>
            </div>
