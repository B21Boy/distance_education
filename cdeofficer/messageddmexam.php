                ...
                <div class="admin-page-shell">
                    <div class="admin-page-header">
                        <div>
                            ...
                            <h1 class="admin-page-title">Seen Module Exam Requests</h1>
                            <p class="admin-page-copy">View module exam marking requests that have already been reviewed and moved into the seen list.</p>
                        </div>
                    </div>
                    <div class="admin-page-panel">
                        <div class="admin-page-toolbar">
                            ...
                            <span class="page-stat-chip"><?php echo $seenCount; ?> seen module exam records</span>
                        </div>
                        <?php if ($seenCount != '0') { ?>
                        ...
                        <?php } else { ?>
                        <div class="admin-page-empty">No seen module exam requests are available yet.</div>
                        <?php } ?>
                    </div>
                </div>
            </div>
