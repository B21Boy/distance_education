...
body.student-portal-page .page-nav-links {
    display: flex;
    flex-wrap: wrap;
    gap: 12px;
}

body.student-portal-page .page-stat-chip {
    display: inline-flex;
    align-items: center;
    padding: 8px 12px;
    border-radius: 999px;
...
body.student-portal-page .table-action-link {
    color: #1f6fb2;
    font-weight: 700;
    text-decoration: none;
}

body.student-portal-page .table-action-link:hover {
