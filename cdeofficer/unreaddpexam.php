                ...
                <div class="admin-page-shell">
                    <div class="admin-page-header">
                        <div>
                            ...
                            <h1 class="admin-page-title">Unread Prepared Exam Requests</h1>
                            <p class="admin-page-copy">Handle unseen prepared exam payment requests in the same standard layout used across the newer CDE officer pages.</p>
                        </div>
                    </div>
                    <div class="admin-page-panel">
                        <div class="admin-page-toolbar">
                            <div class="page-nav-links">
                                <a class="page-nav-link is-primary" href="unreaddpexam.php">Unseen Requests [<?php echo $pendingCount; ?>]</a>
                            ...
                            <span class="page-stat-chip"><?php echo $pendingCount; ?> pending prepared exam requests</span>
                        </div>
                            ...
                            <table class="admin-page-table">
                                ...
                                <?php while ($row = mysql_fetch_array($rs)) { ?>
                                    <tr>
                                        ...
                                        <td><a class="table-action-link" rel="facebox" href="calculatepfexam.php?id=<?php echo $row['no']; ?>">Fill and Calculate Pay Form</a></td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                            </table>
                        ...
                        <?php } else { ?>
                        <div class="admin-page-empty">No new prepared exam payment requests were found.</div>
                        <?php } ?>
                    </div>
                </div>
            </div>
