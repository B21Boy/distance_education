...
if (isset($_SESSION['sun']) && isset($_SESSION['spw']) && isset($_SESSION['sfn']) && isset($_SESSION['sln']) && isset($_SESSION['srole'])) {
    ...
    $requestType = 'massignment';
    $seenPage = 'messageddmassignment.php';
                ...
                <div class="admin-page-shell">
                    <div class="admin-page-header">
                        <div>
                            ...
                            <h1 class="admin-page-title">Unread Module Assignment Requests</h1>
                            <p class="admin-page-copy">Check unseen module assignment marking requests, calculate the payment sheet, and send confirmed entries to finance.</p>
                        </div>
                    </div>
                    <div class="admin-page-panel">
                        <div class="admin-page-toolbar">
                            <div class="page-nav-links">
                                <a class="page-nav-link is-primary" href="unreaddmassignment.php">Unseen Requests [<?php echo $pendingCount; ?>]</a>
                            ...
                            <span class="page-stat-chip"><?php echo $pendingCount; ?> pending assignment requests</span>
                        </div>
                            ...
                            <table class="admin-page-table">
                                ...
                                <?php while ($row = mysql_fetch_array($rs)) { ?>
                                    <tr>
                                        ...
                                        <td><a class="table-action-link" rel="facebox" href="calculatemassignment.php?id=<?php echo $row['no']; ?>">Fill and Calculate Pay Form</a></td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                            </table>
                        ...
                        <?php } else { ?>
                        <div class="admin-page-empty">No new module assignment payment requests were found.</div>
                        <?php } ?>
                    </div>
                </div>
            </div>
