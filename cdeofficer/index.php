...
<div class="cde-dashboard">
    <div class="cde-dashboard-hero">
        <h2 class="cde-dashboard-title">CDE Officer Requests</h2>
        <p class="cde-dashboard-copy">Review all incoming program, exam, and marking requests from a wider dashboard layout.</p>
    </div>
