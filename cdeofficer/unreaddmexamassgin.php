...
if (isset($_SESSION['sun']) && isset($_SESSION['spw']) && isset($_SESSION['sfn']) && isset($_SESSION['sln']) && isset($_SESSION['srole'])) {
    ...
    $requestType = 'mexamassign';
    $seenPage = 'messageddmexamassign.php';
                ...
                <div class="admin-page-shell">
                    <div class="admin-page-header">
                        <div>
                            ...
                            <h1 class="admin-page-title">Unread Exam and Assignment Requests</h1>
                            <p class="admin-page-copy">Review combined marking requests that include both exam and assignment payments before sending them to finance.</p>
                        </div>
                    </div>
                    <div class="admin-page-panel">
                        <div class="admin-page-toolbar">
                            <div class="page-nav-links">
                                <a class="page-nav-link is-primary" href="unreaddmexamassgin.php">Unseen Requests [<?php echo $pendingCount; ?>]</a>
                            ...
                            <span class="page-stat-chip"><?php echo $pendingCount; ?> pending combined requests</span>
                        </div>
                            ...
                            <table class="admin-page-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>No of Assignments Marked</th>
                                        <th>Payment Per Exam</th>
                                        <th>Payment Per Assignment</th>
                                        <th>Total for Exams</th>
                                        <th>Total for Assignments</th>
                                        <th>Total Payment</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                ...
                                <?php while ($row = mysql_fetch_array($rs)) { ?>
                                    <tr>
                                        ...
                                        <td><a class="table-action-link" rel="facebox" href="calculatemexamassign.php?id=<?php echo $row['no']; ?>">Fill and Calculate Pay Form</a></td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                            </table>
                        ...
                        <?php } else { ?>
                        <div class="admin-page-empty">No new combined exam and assignment payment requests were found.</div>
                        <?php } ?>
                    </div>
                </div>
            </div>
