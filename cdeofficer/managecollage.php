...
?>
	...
	<div id="contentindex5">
				<div id="content" class="clearfix">
					...
					<a rel="facebox" href="addcollega.php" style="margin-left: 500px">Add Collage</a>
					
<table cellpadding="1" cellspacing="1" id="resultTable">
						<thead>
							<tr>
								<th  style="border-left: 1px solid #C1DAD7">Collage Code </th>
								<th  style="border-left: 1px solid #C1DAD7">Collage Name</th>
						...
						<?php
							include('../connection.php');
							$result = mysql_query("SELECT * FROM collage");
