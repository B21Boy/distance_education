    ...
    <div class="main-row">
        ...
        <div id="content">
            <div id="contentindex5">
                <center>Well Come To collage dean Page</center>
            </div>
        </div>
        ...
        <div id="sidebar">
            <div id="siderightindexphoto">
                ...
                <p>
                    <b><font color="blue">Welcome:</font><font color="#c2150c">(<?php echo $first_name . "&nbsp;&nbsp;&nbsp;" . $last_name; ?>)</font></b>
                </p>
                <?php if ($photo_path !== '') { ?>
                <p><b><img src="<?php echo $photo_path; ?>" width="180" height="160" alt="Collage dean profile photo"></b></p>
                <?php } ?>
