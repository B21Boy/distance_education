        ...
        <div id="contentindex5">
            <div class="registrar-page-card">
                <div class="registrar-page-header">
                    ...
                    <h1 class="registrar-page-title">View Student Data</h1>
                    <p class="registrar-page-copy">Filter by department, class year, and semester to load student records for review.</p>
                </div>
                <form action="sendstudentlist.php" method="post" class="registrar-form-grid">
                    <div class="registrar-form-field">
                        <label class="registrar-label" for="viewstudent-department">Department</label>
                        <select name="dpt" id="viewstudent-department" class="registrar-select" required>
                    ...
                    <div class="registrar-form-field">
                        <label class="registrar-label" for="viewstudent-year">Student Class Year</label>
                        <select name="scy" id="viewstudent-year" class="registrar-select" required>
                    ...
                    <div class="registrar-form-field">
                        <label class="registrar-label" for="viewstudent-semester">Semester</label>
                        <select name="sem" id="viewstudent-semester" class="registrar-select" required>
                    ...
                    <div class="registrar-form-field full">
                        <div class="registrar-actions">
                            <button type="submit" name="search" class="registrar-btn">View Students</button>
                        </div>
                    </div>
                </form>
            </div>
