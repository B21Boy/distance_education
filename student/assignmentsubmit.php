...
studentRenderPageStart(
    ...
    "Choose the assignment you want to submit. Each row opens the matching upload form so submission stays tied to the correct assignment record.",
...
<?php if (empty($assignments)) { ?>
    <div class="student-empty-state">No instructor-posted assignments are ready for submission yet.</div>
<?php } else { ?>
        ...
        <table cellpadding="1" cellspacing="1" id="resultTable">
            ...
            <?php foreach ($assignments as $assignment) { ?>
                <tr>
                    ...
                    <td><?php echo studentH($assignment['fileName'] ?? ''); ?></td>
                    <td><a class="student-action-link secondary" rel="facebox" href="uploadassignment.php?id=<?php echo urlencode((string) ($assignment['no'] ?? '')); ?>">Upload</a></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
