...
<?php
$query = mysql_query("select * from payment_table where status='yes' and unread='yes' and payment='check' and type='tutorial'")or die(mysql_error());
...
<a href="messageddotutorial.php"><i class="icon-envelope-alt"></i><font size="4px"> All Paid Request</font></a>
									...
									<font size="3px">
<?php
$sql = "select * from payment_table where status='yes' and unread='yes' and payment='check' and type='tutorial'";
...
<td><?php echo '<a href="updateotutorial.php?id='.$row['no'].'">Accept</a>';?></td>
</div>
