                    ...
                    <tr>
                        <td valign="top" height="600px" width="635">
                            <form method="POST" action="viewnotification.php">
                                <table align="center" border="0" cellpadding="10" height="60" bgcolor="#EEEEEE">
                                    <tr>
...
else
{
    while ($row = mysql_fetch_array($result))
    {
        ...
        echo "<br/> $row[date_sended]"."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".'<a rel="facebox" href="viewnotification1.php?M_ID='.$row['M_ID'].'">'."Replay".'</a>';
        echo "</table>";
    }
}
?>
