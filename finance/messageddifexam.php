...
<?php
$query = mysql_query("select * from payment_table where status='yes' and unread='yes' and payment='check' and type='iexam'")
or die(mysql_error());
$coun = mysql_num_rows($query);
?>		
										
<a href="unreaddifexam.php"><i class="icon-check"></i><font size="4px"> UNPaid Request [&nbsp;<?php echo $coun?>&nbsp;]</font></a>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<a href="messageddifexam.php"><i class="icon-envelope-alt"></i><font size="4px"> All Paid Request</font></a>
<p align="center" style="color: #2773d8;font-family: time new romans;font-size: 17;">Number of record:<?php 
$count_item=mysql_query("select * from payment_table where status='yes' and unread='yes' and payment='checked' and type='iexam'" ) or die(mysql_error());
$count=mysql_num_rows($count_item);	
echo"<font color='red'>".($count)."</font>"; ?></p>							
									<?php
$query1 = mysql_query("select * from payment_table where status='yes' and unread='yes' and payment='checked' and type='iexam'")
or die(mysql_error());
?>

<?php	
							
$sql = "SELECT * FROM payment_table where status='yes' and unread='yes' and payment='checked' and type='iexam'";
