...
<a href="messageddmexam.php"><i class="icon-envelope-alt"></i><font size="4px"> All Paid Request</font></a>
									...
									<font size="3px">
<?php
$sql = "select * from payment_table where status='yes' and unread='yes' and payment='check' and type='mexam'";
	 
	//Create a PS_Pagination object
	$pager = new PS_Pagination($conn, $sql,5, 1);
 	//The paginate() function returns a mysql result set for the current page
	$rs = $pager->paginate();									
$query1 = mysql_query("select * from payment_table where status='yes' and unread='yes' and payment='check' and type='mexam'")
or die(mysql_error());
...
<td><?php echo '<a  href="updatemexam.php?id='.$row['no'].'">Accept</a>';?></td>
</div>
